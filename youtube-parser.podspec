...
Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/sahin/youtube-parser"
  s.license          = "MIT"
  s.author           = { "Sahin Boydas" => "nomail@gmail.com" }
  s.source           = { :git => "https://github.com/sahin/youtube-parser.git", :tag => s.version.to_s }
