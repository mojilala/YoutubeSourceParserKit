...
open class Youtube: NSObject {
    ...
    public static func h264videosWithYoutubeID(_ youtubeID: String) -> [String: Any]? {
        guard let parts = loadVideoInfos(youtubeID: youtubeID), !parts.isEmpty else {
            return nil
        }
     ...
     */
    public static func h264videosWithYoutubeURL(_ youtubeURL: URL, completion: ((_ videoInfo: [String: Any]?, _ error: NSError?) -> Void)?) {
